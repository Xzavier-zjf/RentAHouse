...
VALUES ('admin', '$2a$10$VHHczdlDui6zgEYioQVMuOCaD1/yxoAVnhSJfCWLriOye/axigZkC', 'admin@example.com', 1, 'admin')
ON DUPLICATE KEY UPDATE password = '$2a$10$VHHczdlDui6zgEYioQVMuOCaD1/yxoAVnhSJfCWLriOye/axigZkC';
